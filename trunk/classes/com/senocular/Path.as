...
class com.senocular.Path {
	...
	public function circleTo(end_x, end_y, arc, dir):Object {
		...
		o._x += Math.cos(a)*opp;
		o._y += Math.sin(a)*opp;
		var a1:Number = Math.atan2(_position._y-o._y, _position._x-o._x);
		var a2:Number = Math.atan2(end_y-o._y, end_x-o._x);
		if (dir == "CW") {
			if (a2<a1) {
				a2 += Math.PI*2;
			}
